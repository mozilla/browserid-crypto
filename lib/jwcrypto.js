...
exports.encrypt = function(payload, key) {
  return libs.sjcl.json.encrypt(key, payload, {ks: 128, ts: 64, cipher: 'aes', mode: 'ccm'});
};

exports.decrypt = function(encryptedPayload, key) {
  return libs.sjcl.json.decrypt(key, encryptedPayload, {ks: 128, ts: 64, cipher: 'aes', mode: 'ccm'});
};
