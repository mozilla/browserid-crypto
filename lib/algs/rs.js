...
function generate(keysize, rng, cb) {
  ...
  keypair.publicKey.algorithm = keypair.secretKey.algorithm = keypair.algorithm = 'RSA';
...
PublicKey.prototype.serializeToObject = function (obj) {
  obj.n = this.rsa.n.toBase64URL();
  obj.e = new BigInteger(this.rsa.e.toString(), 10).toBase64URL();
};
...
PublicKey.prototype.deserializeFromObject = function(obj) {
  ...
  // presence of .kty indicates new format
  if (obj.kty) {
...
SecretKey.prototype.serializeToObject = function(obj) {
  ...
  obj.n = this.rsa.n.toBase64URL();
  obj.e = new BigInteger(this.rsa.e.toString(), 10).toBase64URL();
  obj.d = this.rsa.d.toBase64URL();
};

SecretKey.prototype.deserializeFromObject = function(obj) {
  this.rsa = new libs.RSAKey();

  // key off presence of `.kty` property to determine if this is new format
  if (obj.kty) {
