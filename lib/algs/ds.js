...
var KEYSIZES = {
  ...
  //
  // NOTE: For backwards compatibility, we label this both 128 and 160.
  // The code is duplicated because these objects will be modified in 
  // place and converted to bigints elsewhere.
  128: {
...
function generate(keysize, rng, doneCB) {
  ...
  if (!params)
    throw algs.KeySizeNotSupportedError("bad key size: " + keysize.toString());
