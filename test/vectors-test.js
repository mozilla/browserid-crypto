...
var CERTS = [
  ...
  } /* ,
  {
    ...
    "email":"user@exampleidp.com",
    certifierPublicKey: {"algorithm":"RS","modulus":"Zx5aDEB62oTwkoTikAp4ck-HGQv4oIa8-L5KdjcANbvjR2jtXAjswepZrwvzYFhP_mwFl_Oy4YElW3OyPy9I6K0OR0xQgBsOprpEOFNEFs14Jy9LJi59yb4gA-xSUlN_SN8s0JKzQ2jYwD8ibZicZWt2C2vvyaBmWaUZm2o5V59DYH6D7ecZSPkwWi9PoD3lCeK2ZeJa7jZpD02bCvybbwyFnDPca2o9MP7_r8Fs6BWJqGAIxlDqvvLUZ-2CeKAie5a98lyBvE__kc0ANY9yjDcWp-c7IXx-lSn5AobiicM2PbiWUdqAXWOguf61ooT1yGazSAeAhZElcy-jd8VZ3Q==","exponent":"AQAB"},
    containedPublicKey: {"algorithm":"DS","y":"EgxmUUA4YD_wNDJH3mX-QTIiIwDtn2cAaCkXr0HGKFN3eTuoOqt6iCvTXEkFZCSIog9ml6wKIasJO8mcT-ZVD-40oD-CXKeRJ7LXPnpSuB5rSvgUxEtVY4_8wWra5RnhoHn8BOgb6tq_zOn9EEV6nE6h_t4rVb_dLW1QTono1Q8=","p":"_2AEg9tqv8W0Xqt4WUs1M9VQ2fG_Kpkqeo2qbcNPgEWtTm4MQp0zTu6q79fiPUgQvgDkzBSSy6MluoH_LVpbMFqNF-s79KBqNJ05LgDTKXRKUXk4A0ToKhjEeTNDj4keIq7vgS1pyPdeMmy3DqAAw_d239vWBGOMLvcX_CbQLhc=","q":"4h4E-RHR7XmRAI7Kqzv3dZhDCcM=","g":"xSpKD_O35h_fGGfOhBODaaYVT0r6kpZuPIJ-Jc-mz1CLkOXeQZ4TN-B6Lp4qPNXepwTRdfjr9q85fWnhELlq-xfHoDJZMp5IKbDQO7x4lrFbSt5T4TCFjMNNliaaqJBB9AkTbHJCo4iVydW8ytTzia8dekvROYvQct_6iWIzOXo="}
  } */
];
...
var BACKED_ASSERTIONS = [
  ...
  /*
  {
    ...
    "email": 'user@exampleidp.com',
    certifyingKey: {"algorithm":"RS","modulus":"Zx5aDEB62oTwkoTikAp4ck-HGQv4oIa8-L5KdjcANbvjR2jtXAjswepZrwvzYFhP_mwFl_Oy4YElW3OyPy9I6K0OR0xQgBsOprpEOFNEFs14Jy9LJi59yb4gA-xSUlN_SN8s0JKzQ2jYwD8ibZicZWt2C2vvyaBmWaUZm2o5V59DYH6D7ecZSPkwWi9PoD3lCeK2ZeJa7jZpD02bCvybbwyFnDPca2o9MP7_r8Fs6BWJqGAIxlDqvvLUZ-2CeKAie5a98lyBvE__kc0ANY9yjDcWp-c7IXx-lSn5AobiicM2PbiWUdqAXWOguf61ooT1yGazSAeAhZElcy-jd8VZ3Q==","exponent":"AQAB"}
  }
*/
];
  ...
  suite.addBatch({
    "loading a public key": {
      ...
      "has the right fields": function(pk) {
        if (pkObject.algorithm == "RS") {
          assert.ok(pk.rsa.n);
          assert.ok(pk.rsa.e);
        }

        if (pkObject.algorithm == "DS") {
          assert.ok(pk.y);
          assert.ok(pk.g);
          assert.ok(pk.q);
          assert.ok(pk.p);
  ...
  suite.addBatch({
    "loading a secret key": {
      ...
      "has the right fields": function(sk) {
        if (skObject.algorithm == "RS") {
          assert.ok(sk.rsa.n);
          assert.ok(sk.rsa.d);
          assert.ok(sk.rsa.e);
        }

        if (skObject.algorithm == "DS") {
          assert.ok(sk.x);
          assert.ok(sk.g);
          assert.ok(sk.q);
          assert.ok(sk.p);
